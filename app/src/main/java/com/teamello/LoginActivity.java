...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Setting the Click events of Views
    ...
    /**
     * Shows the progress UI and hides the login form and Logo Image.
     */
    private void showProgress(final boolean show) {
        // the progress spinner and hide the relevant UI components.
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                // I will ask server to give data against this login if available
                // or If Register Post will be called
                Thread.sleep(2000);
            } catch (InterruptedException e) {
                return false;
            }

            // TODO: will Remove this on relevent time.
